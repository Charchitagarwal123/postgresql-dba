...
### EXPLANATION
I built a Flask based PostgreSQL monitoring dashboard that tracks live database activity like connections, long-running queries, locks, and storage usage, and also allows terminating problematic queries.

## Objective
To build an interface for observing real time PostgreSQL database behavior and performance.
